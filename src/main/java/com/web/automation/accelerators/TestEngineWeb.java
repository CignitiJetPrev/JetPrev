...
public class TestEngineWeb {
	...
	public static boolean blnChromeMobile=false;
	public static String strBrowserName=null;
	
	public static TestRunStatus testStatus=null;
	...
	public void beforeSuite(ITestContext context) throws IOException {
		...
		//testStatus=new TestRunStatus("Jet_Privilege","Smoke_TestCases");
	...
	@Parameters("browserChromeOption")
	@BeforeTest(alwaysRun = true, groups = { "smoke", "regression" })
	public void beforeTest(String browserChromeOption,ITestContext context) throws IOException {
		
		if(browserChromeOption.contains("chromemobile"))
		{
			blnChromeMobile=true;
			
		}
		if(browserChromeOption.contains("android-chromemobile"))
		{
			blnChromeMobile=true;
			
		}
		if(browserChromeOption.contains("ie"))
		{
			strBrowserName="windows-ie";
		}
		if(browserChromeOption.contains("firefox"))
		{
			strBrowserName="windows-firefox";
		}
		if(browserChromeOption.contains("chrome"))
		{
			strBrowserName="windows-chrome";
		}
		if(browserChromeOption.contains("android-chromemobile"))
		{
			strBrowserName="android-chromemobile";
		}
