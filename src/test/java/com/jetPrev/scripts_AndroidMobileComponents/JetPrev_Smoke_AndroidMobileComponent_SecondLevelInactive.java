...
public class JetPrev_Smoke_AndroidMobileComponent_SecondLevelInactive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_SecondLevelInactive() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentSecondLevelInactive(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component SecondLevelInactive ","SecondLevelInactive Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelInactive component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelInactive component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
