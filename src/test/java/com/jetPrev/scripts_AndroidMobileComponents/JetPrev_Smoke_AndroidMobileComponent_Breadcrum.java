...
public class JetPrev_Smoke_AndroidMobileComponent_Breadcrum extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Breadcrum() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnbreadcrum(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component Breadcrum ","Breadcrum Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Breadcrum component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Breadcrum component styles in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
