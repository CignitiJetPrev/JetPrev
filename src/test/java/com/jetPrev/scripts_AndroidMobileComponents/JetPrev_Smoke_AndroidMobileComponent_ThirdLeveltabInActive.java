...
public class JetPrev_Smoke_AndroidMobileComponent_ThirdLeveltabInActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_ThirdLeveltabInActive() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentThirdLevelTabInactive(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component ThirdLeveltabInActive ","ThirdLeveltabInActive Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabInActive component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabInActive component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
