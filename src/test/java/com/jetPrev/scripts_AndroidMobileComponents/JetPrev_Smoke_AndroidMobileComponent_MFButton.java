...
public class JetPrev_Smoke_AndroidMobileComponent_MFButton extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_MFButton() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentMFbutton(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component MFButton ","MFButton Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] MFButton component styles in android chrome browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of MFButton component in android chrome browser are not as expected in "+"testData.AppURL"+"URL";
