...
public class JetPrev_Smoke_AndroidMobileComponent_Calendar extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Calendar() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles on mobile are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar component on mobile browser are not as expected in "+"testData.AppURL"+"URL";
