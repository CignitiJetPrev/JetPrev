...
public class JetPrev_Smoke_AndroidMobileComponent_PasswordTextFocus extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PasswordTextFocus() throws Throwable {
		try {
			...
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component passwordtext focus ","passwordtext focus Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component passwordtext focus ","passwordtext focus Component is absent on : " + testData.AppURL );
			}
