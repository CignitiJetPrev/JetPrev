...
public class JetPrev_Smoke_AndroidMobileComponent_H1 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_H1() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentH1(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component H1 ","H1 Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H1 component styles in mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H1 component in mobile browser are not as expected in "+"testData.AppURL"+"URL";
