...
public class JetPrev_Smoke_AndroidMobileComponent_SecondLevelActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_SecondLevelActive() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentSecondLevelActive(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component SecondLevelActive ","SecondLevelActive Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelActive component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelActive component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
