...
public class JetPrev_Smoke_AndroidMobileComponent_Tooltipmessage extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_Tooltipmessage() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentTooltiptext(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component Tooltipmessage ","Tooltipmessage Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Tooltipmessage component styles in chrome are not as expected";
