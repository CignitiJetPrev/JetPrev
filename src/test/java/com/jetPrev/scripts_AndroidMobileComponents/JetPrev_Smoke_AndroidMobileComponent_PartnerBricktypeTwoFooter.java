...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeTwoFooter extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeTwoFooter() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentpartnerbricktypeTwoFooter(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component PartnerBricktypeTwoFooter ","PartnerBricktypeTwoFooter Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwoFooter component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwoFooter component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
