...
public class JetPrev_Smoke_AndroidMobileComponent_whitebtn_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_whitebtn_Week2() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentwhitebtn(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component whitebtn ","whitebtn Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] whitebtn component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of whitebtn component in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
