...
public class JetPrev_Smoke_AndroidMobileComponent_Table2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Table2() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentTable2(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component Table2 ","Table2 Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table2 component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table2 component styles on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
