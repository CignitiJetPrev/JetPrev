...
public class JetPrev_Smoke_AndroidMobileComponent_Mandatory extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Mandatory() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentMandatory(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component MandatoryIcon ","MandatoryIcon Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Mandatory component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
