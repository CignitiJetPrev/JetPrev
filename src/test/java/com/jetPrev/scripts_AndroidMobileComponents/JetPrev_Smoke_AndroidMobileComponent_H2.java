...
public class JetPrev_Smoke_AndroidMobileComponent_H2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_H2() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentH2(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component H2 ","H2 Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H2 component styles in mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H2 component in mobile browser are not as expected in "+"testData.AppURL"+"URL";
