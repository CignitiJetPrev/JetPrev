...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBrickonRHS extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBrickonRHS() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickonRHS component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickonRHS component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
