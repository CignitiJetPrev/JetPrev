...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBrickonRHSDetail extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBrickonRHSDetail() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentpartnerbrickonRHSDetail(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component PartnerBrickonRHSDetail ","PartnerBrickonRHSDetail Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickonRHSDetail component styles on mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickonRHSDetail component on mobile browser are not as expected in "+"testData.AppURL"+"URL";
