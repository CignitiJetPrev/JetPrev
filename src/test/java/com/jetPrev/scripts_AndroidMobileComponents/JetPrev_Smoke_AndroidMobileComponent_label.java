...
public class JetPrev_Smoke_AndroidMobileComponent_label extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_label() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentLabel(testData);
			if(blnbuymiles)
			{
