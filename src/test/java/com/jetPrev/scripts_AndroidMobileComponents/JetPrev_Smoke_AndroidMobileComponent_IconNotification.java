...
public class JetPrev_Smoke_AndroidMobileComponent_IconNotification extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_IconNotification() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentIconNotifications(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component IconNotification ","IconNotification Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] IconNotification component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of IconNotification component in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
