...
public class JetPrev_Smoke_AndroidMobileComponent_SpacingofInstructionText extends TestEngineWeb {
	...
	public void JetPrev_Component_SpacingofInstructionTextr() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentSecondaryText(testData);
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component SpacingofInstructionText ","SpacingofInstructionText Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component SpacingofInstructionText ","SpacingofInstructionText Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SpacingofInstructionText component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SpacingofInstructionText component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
