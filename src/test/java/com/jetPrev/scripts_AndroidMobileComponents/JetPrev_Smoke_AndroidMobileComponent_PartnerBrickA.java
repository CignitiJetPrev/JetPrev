...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBrickA extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBrickA() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentpartnerbrickA(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component PartnerBrickA ","PartnerBrickA Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickA component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickA component on android moble browser are not as expected in "+"testData.AppURL"+"URL";
