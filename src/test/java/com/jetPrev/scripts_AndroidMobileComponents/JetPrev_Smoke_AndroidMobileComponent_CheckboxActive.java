...
public class JetPrev_Smoke_AndroidMobileComponent_CheckboxActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_CheckboxActive() throws Throwable {
		try {
			...
			{
				extentLogs.fail("JetPrev Component CheckboxActive ","CheckboxActive Component is present on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] CheckboxActive component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of CheckboxActive component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
