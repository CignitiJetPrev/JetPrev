...
public class JetPrev_Smoke_AndroidMobileComponent_Table4 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Table4() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentTable4(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component Table4 ","Table4 Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table4 component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table4 component styles on android mobile browser  are not as expected in "+"testData.AppURL"+"URL";
