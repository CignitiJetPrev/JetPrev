...
public class JetPrev_Smoke_AndroidMobileComponent_ThirdLeveltabActive extends TestEngineWeb {
	...
	public void JetPrev_Component_ThirdLeveltabActive() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentThirdlevelTabActive(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component ThirdLeveltabActive ","ThirdLeveltabActive Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabActive component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabActive component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
