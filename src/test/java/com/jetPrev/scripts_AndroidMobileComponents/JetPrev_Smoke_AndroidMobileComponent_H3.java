...
public class JetPrev_Smoke_AndroidMobileComponent_H3 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_H3() throws Throwable {
		try {
			...
			{
				extentLogs.fail("JetPrev Component H3 ","H3 Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H3 component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H3 component in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
