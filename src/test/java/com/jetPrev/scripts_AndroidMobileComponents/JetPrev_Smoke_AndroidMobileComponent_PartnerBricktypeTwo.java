...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeTwo extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeTwo() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentpartnerbricktypeTwo(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component PartnerBricktypeTwo ","PartnerBricktypeTwo Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwo component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwo component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
