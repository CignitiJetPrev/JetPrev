...
public class JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeOne extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_PartnerBricktypeOne() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentpartnerbricktypeOne(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component PartnerBricktypeOne ","PartnerBricktypeOne Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeOne component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeOne component on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
