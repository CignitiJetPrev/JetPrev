...
public class JetPrev_Smoke_AndroidMobileComponent_OldFormfieldAlignment extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_OldFormfieldAlignment() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentoldFormContainer(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles on android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar styles on on android mobile browser are not as expected in "+"testData.AppURL"+"URL";
