...
public class JetPrev_Smoke_AndroidMobileComponent_ExpandcollapseTitle extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_ExpandcollapseTitle() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentExpandtitle(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component ExpandCollapseTitle ","ExpandCollapseTitle Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ExpandCollapseTitle component styles in Mobile are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ExpandCollapseTitle component in Mobile browser are not as expected in "+"testData.AppURL"+"URL";
