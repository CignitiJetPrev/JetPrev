...
public class JetPrev_Smoke_AndroidMobileComponent_Pagination extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidMobileComponent_Pagination() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.pagination();
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component Pagination ","Pagination Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component Pagination ","Pagination Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Pagination component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Pagination component in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
