...
public class ShopJetPrev_TC032_Webaccessiblity extends TestEngineWeb {
	...
	public void ShopJetPrev_TC032_Webaccessiblity() throws Throwable {
		try {
			//testData=testData.getTestData(objDet);
			 ...
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.countryIcon1,"countryIcon");
			
			 
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.ourProgramNew1,"ourProgram");
			 
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.earnJpMilesNew1,"earnJpMiles");
			 
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.useJPMilesNew1,"useJPMiles");
			 
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.offersDealsNew1,"offersDeals");
			 
			 JetPrev.fnWebaccess(JetPrev_Smoke_Locators.bookNowNew1,"bookNow");
			 
//			 boolean blnmobileEmulation=JetPrev.fnHeaderNew();
//			
...
//			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.PROJECT="JetPrivilege Website (JPW)";
