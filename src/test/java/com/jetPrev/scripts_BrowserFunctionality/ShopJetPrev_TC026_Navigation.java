...
public class ShopJetPrev_TC026_Navigation extends TestEngineWeb {
	...
	public void shopJetPrev_TC026_Navigation() throws Throwable {
		try {
			...
			boolean blnLogin=JetPrev.fnnavigation();
			/*if(blnLogin)
			{
		...
		JetPrev.fnUpdateDefectDetails(TestRunStatus.fnReportStatus(26, objIssue));//Change issue no  --- 
	...
	//add this block
		private void fnGetIssueDetails()
		{
			...
			objIssue.SUMMARY="[Affiliate] User is not able to go to the next page by clicking on "+">,<,>>,<<"+" buttons";
			objIssue.DESCRIPTION="[Affiliate] User is not able to go to the next page by clicking on "+">,<,>>,<<"+" buttons";
