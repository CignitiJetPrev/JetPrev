...
public class JetPrev_Smoke_FooterBrandingguidelines extends TestEngineWeb {
	...
	public void JetPrev_BranidngguidelinesFooter() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnBrandingGuidelinesFooter();
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.PROJECT="JetPrivilege Website";
