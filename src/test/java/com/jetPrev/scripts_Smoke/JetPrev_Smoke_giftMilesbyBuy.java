...
public class JetPrev_Smoke_giftMilesbyBuy extends TestEngineWeb {
	...
	public void JetPrev_Smoke_giftMilesbyBuy() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnJetPrevgiftMilesbyBuy(testData);
			if(blnbuymiles)
			{
