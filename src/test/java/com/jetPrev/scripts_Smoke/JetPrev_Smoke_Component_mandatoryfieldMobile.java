...
public class JetPrev_Smoke_Component_mandatoryfieldMobile extends TestEngineWeb {
	...
	public void JetPrev_MandatoryField_Mobile() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fncomponentMandatoryMobile(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory Icon component styles in Android Mobile are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Mandatory Icon component styles in Android Mobile are not as expected in "+"testData.AppURL"+"URL";
