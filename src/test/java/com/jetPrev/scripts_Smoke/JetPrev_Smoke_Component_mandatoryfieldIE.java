...
public class JetPrev_Smoke_Component_mandatoryfieldIE extends TestEngineWeb {
	...
	public void JetPrev_Mandatory_IE() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory Icon component styles in IE are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Mandatory Icon component styles in IE are not as expected in "+"testData.AppURL"+"URL";
