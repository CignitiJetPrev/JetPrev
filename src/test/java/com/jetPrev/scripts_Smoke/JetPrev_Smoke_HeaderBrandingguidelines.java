...
public class JetPrev_Smoke_HeaderBrandingguidelines extends TestEngineWeb {
	...
	public void JetPrev_Branidngguidelines() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnBrandingGuidelinesHeader();
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Branding guidelines of header is not as expected";
		objIssue.DESCRIPTION="[Affiliate] Branding guidelines of header is not as expected";
