...
public class JetPrev_Smoke_Buymiles extends TestEngineWeb {
	...
	public void JetPrev_BuyMiles() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnJetPrevBuymiles(testData);
			if(blnbuymiles)
			{
