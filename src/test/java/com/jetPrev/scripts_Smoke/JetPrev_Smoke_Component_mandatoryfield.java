...
public class JetPrev_Smoke_Component_mandatoryfield extends TestEngineWeb {
	...
	public void JetPrev_Mandatoryfield() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory Icon component styles in Chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Mandatory Icon component styles in chrome are not as expected in "+"testData.AppURL"+"URL";
