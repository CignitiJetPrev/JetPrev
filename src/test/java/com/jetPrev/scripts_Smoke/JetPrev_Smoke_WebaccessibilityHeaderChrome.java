...
public class JetPrev_Smoke_WebaccessibilityHeaderChrome extends TestEngineWeb {
	...
	public void JetPrev_WebaccessibilityHeaderChrome() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnWebaccessibiltyHeader();
			if(blnbuymiles)
			{
		...
		JetPrev.fnUpdateDefectDetails(TestRunStatus.fnReportStatus(16, objIssue));
