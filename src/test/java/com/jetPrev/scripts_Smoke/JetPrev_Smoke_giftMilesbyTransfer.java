...
public class JetPrev_Smoke_giftMilesbyTransfer extends TestEngineWeb {
	...
	public void JetPrev_Smoke_giftmilesBytransfer() throws Throwable {
		try {
			...
			boolean blngiftmiles=JetPrev.fnJetPrevgiftMiles(testData);
			if(blngiftmiles)
			{
