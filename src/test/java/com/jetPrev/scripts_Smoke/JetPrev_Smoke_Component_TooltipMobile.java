...
public class JetPrev_Smoke_Component_TooltipMobile extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_TooltipMobile() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fncomponentHelpTextMobile(testData);
			if(blnbuymiles)
			{
		...
		//JetPrev.fnUpdateDefectDetails(TestRunStatus.fnReportStatus(8, objIssue));
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ToolTip component styles in Android Mobile are not as expected";
		objIssue.DESCRIPTION="[Affiliate] ToolTip component styles in Android Mobile are not as expected in "+"testData.AppURL"+"URL";
