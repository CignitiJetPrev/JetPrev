...
public class JetPrev_Smoke_Component_CalendarFF extends TestEngineWeb {
	...
	public void JetPrev_Component_CalendarFF() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles in FF are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar component in FF browser are not as expected in "+"testData.AppURL"+"URL";
