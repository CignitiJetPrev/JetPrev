...
public class JetPrev_Smoke_Component_CalendarMobile extends TestEngineWeb {
	...
	public void JetPrev_Component_CalendarMobile() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fncomponentcalendarmobile(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles in android mobile are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar component in android mobile are not as expected in "+"testData.AppURL"+"URL";
