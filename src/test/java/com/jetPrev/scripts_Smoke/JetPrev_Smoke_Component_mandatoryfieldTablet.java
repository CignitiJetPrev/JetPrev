...
public class JetPrev_Smoke_Component_mandatoryfieldTablet extends TestEngineWeb {
	...
	public void JetPrev_MandatoryField_Tablet() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fncomponentMandatoryTablet(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory Icon component styles in Android Tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Mandatory Icon component styles in Android Tablet are not as expected in "+"testData.AppURL"+"URL";
