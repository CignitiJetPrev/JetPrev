...
public class JetPrev_Smoke_Component_TooltipIE extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_TooltipIE() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ToolTip component styles in IE are not as expected";
		objIssue.DESCRIPTION="[Affiliate] ToolTip component styles in IE are not as expected in "+testData.AppURL+"URL";
