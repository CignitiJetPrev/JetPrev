...
public class JetPrev_Smoke_Component_Tooltip extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_Tooltip() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ToolTip component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] ToolTip component styles in chrome are not as expected in "+"testData.AppURL"+"URL";
