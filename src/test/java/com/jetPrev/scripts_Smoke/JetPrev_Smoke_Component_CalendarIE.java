...
public class JetPrev_Smoke_Component_CalendarIE extends TestEngineWeb {
	...
	public void JetPrev_Component_CalendarIE() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fncomponentcalendarIE(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles in IE are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar component in IE browser are not as expected in "+"testData.AppURL"+"URL";
