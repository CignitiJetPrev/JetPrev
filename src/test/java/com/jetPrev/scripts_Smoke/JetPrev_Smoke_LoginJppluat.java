...
public class JetPrev_Smoke_LoginJppluat extends TestEngineWeb {
	...
	public void JetPrev_loginJPPLUAT() throws Throwable {
		try {
			...
			boolean blnloginjppluat=JetPrev.fnloginjppluat(testData);
			if(blnloginjppluat)
			{
