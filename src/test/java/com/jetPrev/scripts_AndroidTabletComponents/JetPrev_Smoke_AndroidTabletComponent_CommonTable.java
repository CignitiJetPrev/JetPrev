...
public class JetPrev_Smoke_AndroidTabletComponent_CommonTable extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_CommonTable() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] CommonTable component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of CommonTable component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
