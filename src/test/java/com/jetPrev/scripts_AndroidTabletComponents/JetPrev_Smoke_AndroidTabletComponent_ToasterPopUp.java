...
public class JetPrev_Smoke_AndroidTabletComponent_ToasterPopUp extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ToasterPopUp() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ToasterPopUp component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ToasterPopUp component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
