...
public class JetPrev_Smoke_AndroidTabletComponent_Checkbox extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Checkbox() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] CheckboxInActive component styles in Android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of CheckboxInActive component in Android tablet browser are not as expected in "+"testData.AppURL"+"URL";
