...
public class JetPrev_Smoke_AndroidTabletComponent_H3 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_H3() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H3 component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H3 component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
