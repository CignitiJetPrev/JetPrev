...
public class JetPrev_Smoke_AndroidTabletComponent_spacingfromLeftandRightForm extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_spacingfromLeftandRightForm() throws Throwable {
		try {
			...
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component spacingfromLeftandRightForm ","spacingfromLeftandRightForm Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component spacingfromLeftandRightForm ","spacingfromLeftandRightForm Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] spacingfromLeftandRightForm component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of spacingfromLeftandRightForm component in android tablet browser browser are not as expected in "+"testData.AppURL"+"URL";
