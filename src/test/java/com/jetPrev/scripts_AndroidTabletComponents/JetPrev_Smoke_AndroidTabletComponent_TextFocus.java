...
public class JetPrev_Smoke_AndroidTabletComponent_TextFocus extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_TextFocus() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentTextFieldFocus(testData);
		//	boolean blnbuymiles=JetPrev.fnComponentsWebaccesibility(testData);
			...
			{
				extentLogs.fail("JetPrev Component textfocus ","textfocus Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] textfocus component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of textfocus component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
