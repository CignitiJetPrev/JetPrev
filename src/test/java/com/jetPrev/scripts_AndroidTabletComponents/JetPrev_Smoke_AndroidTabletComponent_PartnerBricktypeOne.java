...
public class JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeOne extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeOne() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeOne component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeOne component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
