...
public class JetPrev_Smoke_AndroidTabletComponent_TextFocusTyped extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_TextFocusTyped() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentTextFieldFocusTyped(testData);
		//	boolean blnbuymiles=JetPrev.fnComponentsWebaccesibility(testData);
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component textfocustyped ","textfocustyped Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component textfocustyped ","textfocustyped Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Textfocustyped component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of textfocustyped component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
