...
public class JetPrev_Smoke_AndroidTabletComponent_PartnerBrickA extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PartnerBrickA() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickA component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickA component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
