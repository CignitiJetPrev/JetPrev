...
public class JetPrev_Smoke_AndroidTabletComponent_ThirdLeveltabActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ThirdLeveltabActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabActive component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabActive component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
