...
public class JetPrev_Smoke_AndroidTabletComponent_SecondaryButton extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_SecondaryButton() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentSecondaryButton(testData);
			if(blnbuymiles)
			{
			...
			{
				extentLogs.fail("JetPrev Component SecondaryButton ","SecondaryButton Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondaryButton component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondaryButton component on android tablet browser browser are not as expected in "+"testData.AppURL"+"URL";
