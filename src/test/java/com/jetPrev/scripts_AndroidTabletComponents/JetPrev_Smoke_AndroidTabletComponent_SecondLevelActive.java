...
public class JetPrev_Smoke_AndroidTabletComponent_SecondLevelActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_SecondLevelActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelActive component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelActive component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
