...
public class JetPrev_Smoke_AndroidTabletComponent_FormLabel extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_FormLabel() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] FormLabel component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of FormLabel component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
