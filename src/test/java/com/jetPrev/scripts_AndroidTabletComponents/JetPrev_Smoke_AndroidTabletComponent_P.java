...
public class JetPrev_Smoke_AndroidTabletComponent_P extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_P() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] P component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of P component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
