...
public class JetPrev_Smoke_AndroidTabletComponent_SecondLevelInactive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_SecondLevelInactive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelInactive component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelInactive component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
