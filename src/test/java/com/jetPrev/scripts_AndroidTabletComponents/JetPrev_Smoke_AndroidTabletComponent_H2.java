...
public class JetPrev_Smoke_AndroidTabletComponent_H2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_H2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H2 component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H2 component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
