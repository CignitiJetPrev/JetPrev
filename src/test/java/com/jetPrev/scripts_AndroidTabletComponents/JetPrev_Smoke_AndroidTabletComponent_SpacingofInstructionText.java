...
public class JetPrev_Smoke_AndroidTabletComponent_SpacingofInstructionText extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_SpacingofInstructionText() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SpacingofInstructionText component styles in android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SpacingofInstructionText component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
