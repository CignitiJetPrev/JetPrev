...
public class JetPrev_Smoke_AndroidTabletComponent_ContentLevelTab extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ContentLevelTab() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ContentLevelTab component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ContentLevelTab component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
