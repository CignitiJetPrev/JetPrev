...
public class JetPrev_Smoke_AndroidTabletComponent_ActionButtonExternalURL extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ActionButtonExternalURL() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ActionButtonExternalURL component styles on Android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ActionButtonExternalURL component on Android tablet browser are not as expected in "+"testData.AppURL"+"URL";
