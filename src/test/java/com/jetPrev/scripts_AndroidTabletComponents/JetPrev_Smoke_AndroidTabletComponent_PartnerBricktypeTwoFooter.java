...
public class JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeTwoFooter extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeTwoFooter() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwoFooter component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwoFooter component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
