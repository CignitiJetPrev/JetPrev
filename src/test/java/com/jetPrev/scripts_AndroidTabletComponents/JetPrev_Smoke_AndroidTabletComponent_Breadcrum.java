...
public class JetPrev_Smoke_AndroidTabletComponent_Breadcrum extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Breadcrum() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Breadcrum component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Breadcrum component styles in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
