...
public class JetPrev_Smoke_AndroidTabletComponent_H1 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_H1() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H1 component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H1 component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
