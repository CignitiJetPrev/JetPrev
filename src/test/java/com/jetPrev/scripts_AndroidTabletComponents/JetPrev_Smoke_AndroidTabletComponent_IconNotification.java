...
public class JetPrev_Smoke_AndroidTabletComponent_IconNotification extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_IconNotification() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] IconNotification component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of IconNotification component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
