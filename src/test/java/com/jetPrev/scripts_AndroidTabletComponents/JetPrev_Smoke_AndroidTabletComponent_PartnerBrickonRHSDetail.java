...
public class JetPrev_Smoke_AndroidTabletComponent_PartnerBrickonRHSDetail extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PartnerBrickonRHSDetail() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickonRHSDetail component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickonRHSDetail component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
