...
public class JetPrev_Smoke_AndroidTabletComponent_whitebtn_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_whitebtn_Week2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] whitebtn component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of whitebtn component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
