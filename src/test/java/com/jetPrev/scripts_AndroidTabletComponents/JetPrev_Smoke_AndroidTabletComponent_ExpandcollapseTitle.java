...
public class JetPrev_Smoke_AndroidTabletComponent_ExpandcollapseTitle extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ExpandcollapseTitle() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ExpandCollapseTitle component styles in android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ExpandCollapseTitle component in android tablet are not as expected in "+"testData.AppURL"+"URL";
