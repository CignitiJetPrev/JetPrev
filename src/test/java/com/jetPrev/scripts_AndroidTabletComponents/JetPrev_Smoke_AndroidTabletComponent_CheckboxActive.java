...
public class JetPrev_Smoke_AndroidTabletComponent_CheckboxActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_CheckboxActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] CheckboxActive component styles in android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of CheckboxActive component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
