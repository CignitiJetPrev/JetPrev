...
public class JetPrev_Smoke_AndroidTabletComponent_OldFormfieldAlignment extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_OldFormfieldAlignment() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar styles on on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
