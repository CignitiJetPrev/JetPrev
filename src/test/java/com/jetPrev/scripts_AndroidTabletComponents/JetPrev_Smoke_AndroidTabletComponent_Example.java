...
public class JetPrev_Smoke_AndroidTabletComponent_Example extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Example() throws Throwable {
		try {
