...
public class JetPrev_Smoke_AndroidTabletComponent_NewFormLabel extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_NewFormLabel() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] NewFormLabel component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of NewFormLabel component in android mobile tablet are not as expected in "+"testData.AppURL"+"URL";
