...
public class JetPrev_Smoke_AndroidTabletComponent_Mandatory extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Mandatory() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Mandatory component styles in android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Mandatory component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
