...
public class JetPrev_Smoke_AndroidTabletComponent_PasswordText extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PasswordText() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] passwordtext component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of passwordtext component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
