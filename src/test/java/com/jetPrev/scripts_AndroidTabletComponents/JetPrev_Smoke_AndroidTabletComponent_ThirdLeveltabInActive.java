...
public class JetPrev_Smoke_AndroidTabletComponent_ThirdLeveltabInActive extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ThirdLeveltabInActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabInActive component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabInActive component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
