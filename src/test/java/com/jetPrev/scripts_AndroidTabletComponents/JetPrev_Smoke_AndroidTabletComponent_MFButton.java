...
public class JetPrev_Smoke_AndroidTabletComponent_MFButton extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_MFButton() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] MFButton component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of MFButton component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
