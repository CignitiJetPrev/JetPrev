...
public class JetPrev_Smoke_AndroidTabletComponent_ExternalLink extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_ExternalLink() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentExternalLink(testData);
			if(blnbuymiles)
			{
