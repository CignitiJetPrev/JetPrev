...
public class JetPrev_Smoke_AndroidTabletComponent_BreadcrumPresentation extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_BreadcrumPresentation() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] BreadcrumPresentation component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of BreadcrumPresentation component android tablet browser are not as expected in "+"testData.AppURL"+"URL";
