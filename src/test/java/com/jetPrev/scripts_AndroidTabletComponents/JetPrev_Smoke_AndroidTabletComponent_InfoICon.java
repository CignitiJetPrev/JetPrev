...
public class JetPrev_Smoke_AndroidTabletComponent_InfoICon extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_InfoICon() throws Throwable {
		try {
			...
			{
				extentLogs.fail("JetPrev Component HelpText ","HelpText Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles in android tablet chrome are not as expected";
