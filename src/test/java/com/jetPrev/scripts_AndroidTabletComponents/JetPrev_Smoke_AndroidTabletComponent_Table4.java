...
public class JetPrev_Smoke_AndroidTabletComponent_Table4 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Table4() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table4 component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table4 component styles on android tablet browser  are not as expected in "+"testData.AppURL"+"URL";
