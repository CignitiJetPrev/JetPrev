...
public class JetPrev_Smoke_AndroidTabletComponent_Calendar extends TestEngineWeb {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Calendar component styles on Android Tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of calendar component on Android Tablet browser are not as expected in "+"testData.AppURL"+"URL";
