...
public class JetPrev_Smoke_AndroidTabletComponent_Pagination extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Pagination() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Pagination component styles in android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Pagination component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
