...
public class JetPrev_Smoke_AndroidTabletComponent_Table2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_Table2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table2 component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table2 component styles on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
