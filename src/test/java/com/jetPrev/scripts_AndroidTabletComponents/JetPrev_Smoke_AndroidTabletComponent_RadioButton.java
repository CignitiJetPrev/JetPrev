...
public class JetPrev_Smoke_AndroidTabletComponent_RadioButton extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_RadioButton() throws Throwable {
		try {
			...
			boolean blnbuymiles=JetPrev.fnComponentRadioButton(testData);
			if(blnbuymiles)
			{
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] RabioButton component styles in android mobile browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Radiobutton component in android mobile browser are not as expected in "+"testData.AppURL"+"URL";
