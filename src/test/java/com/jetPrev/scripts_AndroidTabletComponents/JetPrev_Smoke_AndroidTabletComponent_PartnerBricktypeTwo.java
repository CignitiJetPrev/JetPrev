...
public class JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeTwo extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PartnerBricktypeTwo() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwo component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwo component on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
