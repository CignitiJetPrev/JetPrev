...
public class JetPrev_Smoke_AndroidTabletComponent_PostLoginNotification extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_PostLoginNotification() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PostLoginNotification component styles in android tablet are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PostLoginNotification component in android tablet browser are not as expected in "+"testData.AppURL"+"URL";
