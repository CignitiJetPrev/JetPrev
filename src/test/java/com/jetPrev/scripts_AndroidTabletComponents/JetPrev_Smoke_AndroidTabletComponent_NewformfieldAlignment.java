...
public class JetPrev_Smoke_AndroidTabletComponent_NewformfieldAlignment extends TestEngineWeb {
	...
	public void JetPrev_Smoke_AndroidTabletComponent_NewformfieldAlignment() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] NewformfieldAlignment component styles on android tablet browser are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of NewformfieldAlignment component styles on android tablet browser are not as expected in "+"testData.AppURL"+"URL";
