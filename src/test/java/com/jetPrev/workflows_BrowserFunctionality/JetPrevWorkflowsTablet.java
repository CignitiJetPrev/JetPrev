...
public class JetPrevWorkflowsTablet extends BasePage {
	public WebDriver driver=ActionsLibrary.driver;
	//public EventFiringWebDriver driver;
	public ExtentLogs extentLogs = new ExtentLogs();
	Optional<Long> timeoutInSecond = Optional.of(Long.parseLong("5"));

	public JetPrevWorkflowsTablet(WebDriver driver) {
		...
		for (int i = 0; i<linkone.size(); i++)
 		{
			...
			for (int j = 0; j<linktwo.size(); j++)
	 		{
			//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
			actionLib.validateCheckStyleAllComponents(linktwo.get(j), "HelpTextMessageTablet");
			}
						}
			}
			}
		...
		for (int i = 0; i<linkone.size(); i++)
 		{
			...
			if(str.contains("helpText")){
			//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
			actionLib.validateCheckStyleAllComponents(linkone.get(i), "HelpTextTablet");
			}
						}
			}
			catch(Exception e) {
		...
		for (int i = 0; i<linkone.size(); i++)
 		{
			...
			if(str.contains(str2)) {
				actionLib.validateCheckStyleAllComponents(linkone.get(i), "MandatoryFieldTablet");
			}
			else {
		...
		for (int i = 0; i<linkone.size(); i++)
 		{
			...
			System.out.println(str);
				...
				actionLib.validateCheckStyleAllComponents(linkone.get(i), "CalendarTablet");
			}else {
...
for (int i = 0; i<linktwo.size(); i++)
	...
	try {
		...
		actionLib.validateCheckStyleAllComponents(linktwo.get(i), "TextFieldTablet");
		/*Thread.sleep(4000);
		Actions a = new Actions(driver);
...
for (int i = 0; i<linktwo.size(); i++)
	...
	try {
		...
		/*linktwo.get(i).click();
		linktwo.get(i).sendKeys("1");
*/		actionLib.validateCheckStyleAllComponents(linktwo.get(i), "TextFieldFocusTablet");
...
*/		linktwo.get(i).sendKeys("abcd");
		actionLib.validateCheckStyleAllComponents(linktwo.get(i), "TextFieldFocusTypedTablet");
	} catch (Exception e) {
		// TODO Auto-generated catch block
		continue;
	}
...
for (int i = 0; i<linktwo.size(); i++)
	...
	if(str.contains("checkbox")) {
		try {
			...
			actionLib.validateCheckStyleAllComponents(linktwo.get(i), "CheckboxInactiveTablet");
				} catch (Exception e) {
			// TODO Auto-generated catch block
			continue;
		}
	...
	if(str.contains("checkbox")) {
		try {
			...
			try {
				...
				actionLib.validateCheckStyleAllComponents(linktwo.get(i), "CheckboxActiveTablet");
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
...
for (int i = 0; i<linktwo.size(); i++)
	...
	/*if(str.contains("radio")) {*/
		try {
			actionLib.validateCheckStyleAllComponents(linktwo.get(i), "RadiobuttonInactiveTablet");
			Actions a = new Actions(driver);
			a.moveToElement(linktwo.get(i),1,1).build().perform();
			...
			linktwo.get(i).click();
			actionLib.validateCheckStyleAllComponents(linktwo.get(i), "RadiobuttonActiveTablet");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			continue;
		}
...
if(linktwo.get(i).isDisplayed()) {
	...
	if(str.contains(str2)){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linktwo.get(i), "PrimaryButtonTablet");
	}
	else {
...
if(linktwo.get(i).isDisplayed()) {
	...
	if(str.contains(str2)) {
		actionLib.validateCheckStyleAllComponents(linktwo.get(i), "SecondaryButtonTablet");
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("text")){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "InputFieldTablet");
	}
	if(str.contains("checkbox")) {
		actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ButtonBlueTablet");
	}
     }
	}
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ExternalLinkTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains(str1)){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "PDFPrintTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains(str1)){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "CountryIconTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains(str1)){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "OutsideButtonTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ActionButtonExternalURLTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains(str1)){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "WhiteBtnTablet");
	}
	else {
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "OldFormLabelTablet");
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "NewFormLabelTablet");
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ExpandTitleTablet");
	/*Actions a = new Actions(driver);
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		//actionLib.HighlightWebElement(linkthree.get(i), 3);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "Tabletrack2Tablet");	
...
for (int i = 0; i<linkfour.size(); i++) {
			...
			actionLib.validateCheckStyleAllComponents(linkfour.get(i), "Tablecaption2Tablet");
		}
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		actionLib.HighlightWebElement(linkthree.get(i), 3);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "CommonTableTablet");
		}     }
	}
	}
String str1 = null;
...
for (int i = 0; i<linkfour.size(); i++) {
			...
			actionLib.validateCheckStyleAllComponents(linkfour.get(i), "CommonTablecaptionTablet");
		}
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		actionLib.HighlightWebElement(linkthree.get(i), 3);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "Table4Tablet");
		}     }
	}
	}
...
if(linkfour.get(i).isDisplayed()) {
	...
	if(str!=null) {
		if(str1.contains("table caption")) {
			actionLib.validateCheckStyleAllComponents(linkfour.get(i), "Tablecaption4Tablet");
		}
	}
}
}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "OldFormContainerTablet");
		}
	if(str.contains("innerContainer")) {
		actionLib.validateCheckStyleAllComponents(linkthree.get(i), "OldFormInnerContainerTablet");
	}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("formContainer")){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "NewFormContainerTablet");
	if(str.contains("innerContainer")){
		//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		actionLib.validateCheckStyleAllComponents(linkthree.get(i), "NewInnerContainerTablet");
...
/*	str = linkthree.get(i).getAttribute("class");
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
*/	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "PTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("mainHeading")){
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "H1Tablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "H2Tablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "h3Tablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		//Thread.sleep(3000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "BreadcrumTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "PresentationTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "SecondaryTextTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "PostloginNotificationsTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "IconIconNotificationTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "OldFormtemplateTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
		//Thread.sleep(3000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "TooltipmessageTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("pin-note")){*/
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ThirdLeveltabActiveTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ThirdLeveltabInactiveTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ContentLeveltabActiveTablet");
	
	}
	if(str.contains("desklist")){
		actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ContentLeveltabInActiveTablet");
	}
	 }
	   }
	     }
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("partnerDetailLink")){
		Thread.sleep(2000);
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbricktypeOneTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbrickATablet");
			}
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains(str2)){
		Thread.sleep(2000);
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbricktypeTwoTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("cardDetailCont")){
		Thread.sleep(2000);
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbricktypeTwoFooterTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("partnerDetailLink")){
		Thread.sleep(2000);
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbrickonRHSTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	if(str.contains("cardDetailCont")){
		...
		Thread.sleep(1000);
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "partnerbrickonRHSDetailTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
    	 ...
    	 Thread.sleep(2000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "SecondLevelInactiveTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
    	 ...
    	 Thread.sleep(2000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "SecondLevelActiveTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
    	 ...
    	 Thread.sleep(2000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "TabpopupcomponentTablet");
...
for (int i = 0; i<linkthree.size(); i++)
	...
	//System.out.println(new Select(linkone.get(i)).getOptions().get(i).getText());
    	 ...
    	 Thread.sleep(2000);
	actionLib.validateCheckStyleAllComponents(linkthree.get(i), "ToasterPopupTablet");
