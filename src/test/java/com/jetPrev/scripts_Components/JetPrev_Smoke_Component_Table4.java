...
public class JetPrev_Smoke_Component_Table4 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_Table4() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table4 component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table4 component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
