...
public class JetPrev_Smoke_Component_PartnerBricktypeOne extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBricktypeOne() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeOne component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeOne component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
