...
public class JetPrev_Smoke_Component_CommonTable extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_CommonTable() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] CommonTable component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of CommonTable component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
