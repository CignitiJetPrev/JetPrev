...
public class JetPrev_Smoke_Component_fnComponentActionButtonExternalURL_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_fnComponentActionButtonExternalURL() throws Throwable {
		try {
			...
			if(blnbuymiles)
			{
				extentLogs.pass("JetPrev Component FormFieldRelatedButton ","FormFieldRelatedButton Component is present on : " + testData.AppURL );
				//First Row 
			...
			{
				extentLogs.fail("JetPrev Component FormFieldRelatedButton ","FormFieldRelatedButton Component is absent on : " + testData.AppURL );
			}
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] FormFieldRelatedButton component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of FormFieldRelatedButton component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
