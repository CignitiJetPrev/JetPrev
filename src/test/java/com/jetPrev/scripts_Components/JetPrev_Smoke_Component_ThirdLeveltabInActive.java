...
public class JetPrev_Smoke_Component_ThirdLeveltabInActive extends TestEngineWeb {
	...
	public void JetPrev_Component_ThirdLeveltabInActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabInActive component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabInActive component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
