...
public class JetPrev_Smoke_Component_MFButton_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_MFButton() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] MFButton component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of MFButton component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
