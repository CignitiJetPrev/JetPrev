...
public class JetPrev_Smoke_Component_SecondLevelActive extends TestEngineWeb {
	...
	public void JetPrev_Component_SecondLevelActive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelActive component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelActive component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
