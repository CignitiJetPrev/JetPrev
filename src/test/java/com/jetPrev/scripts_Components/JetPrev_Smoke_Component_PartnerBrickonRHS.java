...
public class JetPrev_Smoke_Component_PartnerBrickonRHS extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBrickonRHS() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickonRHS component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickonRHS component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
