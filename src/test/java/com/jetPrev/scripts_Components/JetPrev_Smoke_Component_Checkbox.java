...
public class JetPrev_Smoke_Component_Checkbox extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_Checkbox() throws Throwable {
		try {
			...
			{
				extentLogs.fail("JetPrev Component CheckboxInactive ","CheckboxInactive Component is absent on : " + testData.AppURL );
			}
