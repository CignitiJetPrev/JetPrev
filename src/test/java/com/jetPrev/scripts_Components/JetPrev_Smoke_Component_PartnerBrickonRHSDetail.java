...
public class JetPrev_Smoke_Component_PartnerBrickonRHSDetail extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBrickonRHSDetail() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickonRHSDetail component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickonRHSDetail component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
