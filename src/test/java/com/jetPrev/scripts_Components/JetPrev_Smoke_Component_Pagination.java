...
public class JetPrev_Smoke_Component_Pagination extends TestEngineWeb {
	...
	@Test(description = "UAT Environment", groups = { "smoke", "regression" })
	public void JetPrev_Component_Pagination() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Pagination component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Pagination component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
