...
public class JetPrev_Smoke_Component_NewFormLabel extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_NewFormLabel() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] NewFormLabel component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of NewFormLabel component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
