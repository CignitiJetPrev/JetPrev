...
public class JetPrev_Smoke_Component_ExpandcollapseTitle_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_ExpandcollapseTitle_Week2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ExpandCollapseTitle component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ExpandCollapseTitle component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
