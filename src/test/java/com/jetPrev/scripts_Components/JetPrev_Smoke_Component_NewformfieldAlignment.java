...
public class JetPrev_Smoke_Component_NewformfieldAlignment extends TestEngineWeb {
	...
	public void JetPrev_Component_NewformfieldAlignment() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] NewformfieldAlignment component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of NewformfieldAlignment component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
