...
public class JetPrev_Smoke_Component_ContentLevelTab extends TestEngineWeb {
	...
	public void JetPrev_Component_ContentLevelTab() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ContentLevelTab component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ContentLevelTab component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
