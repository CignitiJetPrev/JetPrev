...
public class JetPrev_Smoke_Component_SecondLevelInactive extends TestEngineWeb {
	...
	public void JetPrev_Component_SecondLevelInactive() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] SecondLevelInactive component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of SecondLevelInactive component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
