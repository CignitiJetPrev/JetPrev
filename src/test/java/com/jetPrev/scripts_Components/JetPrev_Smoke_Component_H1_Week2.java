...
public class JetPrev_Smoke_Component_H1_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_H1_Week2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] H1 component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of H1 component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
