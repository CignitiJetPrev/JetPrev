...
public class JetPrev_Smoke_Component_FormLabel_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_FormLabel() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] FormLabel component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of FormLabel component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
