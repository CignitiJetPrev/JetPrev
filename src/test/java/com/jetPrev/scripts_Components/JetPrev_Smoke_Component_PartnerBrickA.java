...
public class JetPrev_Smoke_Component_PartnerBrickA extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBrickA() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBrickA component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBrickA component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
