...
public class JetPrev_Smoke_Component_whitebtn_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_whitebtn() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] whitebtn component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of whitebtn component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
