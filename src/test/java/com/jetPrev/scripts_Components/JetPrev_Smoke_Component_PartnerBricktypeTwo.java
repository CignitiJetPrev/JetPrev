...
public class JetPrev_Smoke_Component_PartnerBricktypeTwo extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBricktypeTwo() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwo component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwo component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
