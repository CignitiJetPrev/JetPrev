...
public class JetPrev_Smoke_Component_IconNotification_Week2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_IconNotification() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] IconNotification component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of IconNotification component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
