...
public class JetPrev_Smoke_Component_Table2 extends TestEngineWeb {
	...
	public void JetPrev_Smoke_Component_Table2() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Table2 component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Table2 component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
