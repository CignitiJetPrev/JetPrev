...
public class JetPrev_Smoke_Component_ThirdLeveltabActive extends TestEngineWeb {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ThirdLeveltabActive component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ThirdLeveltabActive component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
