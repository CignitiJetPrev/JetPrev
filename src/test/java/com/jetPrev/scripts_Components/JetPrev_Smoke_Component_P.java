...
public class JetPrev_Smoke_Component_P extends TestEngineWeb {
	...
	public void JetPrev_Component_P() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] P component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of P component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
