...
public class JetPrev_Smoke_Component_PartnerBricktypeTwoFooter extends TestEngineWeb {
	...
	public void JetPrev_Component_PartnerBricktypeTwoFooter() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] PartnerBricktypeTwoFooter component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of PartnerBricktypeTwoFooter component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
