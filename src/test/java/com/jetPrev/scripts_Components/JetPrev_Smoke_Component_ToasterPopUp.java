...
public class JetPrev_Smoke_Component_ToasterPopUp extends TestEngineWeb {
	...
	public void JetPrev_Component_ToasterPopUp() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] ToasterPopUp component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of ToasterPopUp component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
