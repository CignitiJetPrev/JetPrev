...
public class JetPrev_Smoke_Component_Breadcrum extends TestEngineWeb {
	...
	public void JetPrev_Component_Breadcrum() throws Throwable {
		try {
	...
	private void fnGetIssueDetails()
	{
		...
		objIssue.SUMMARY="[Affiliate] Breadcrum component styles in chrome are not as expected";
		objIssue.DESCRIPTION="[Affiliate] Styles of Breadcrum component in chrome browser are not as expected in "+"testData.AppURL"+"URL";
